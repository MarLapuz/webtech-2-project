...
<html>
    ...
    <body style="background-image: url(loginbackground.png);"><header style="background-color:#68DCFA; color:white; padding: 5px 0px 0px 0px;"><img src="call.png" style="height:15px;">Call Us: (+639) 123 456 7890 &nbsp;&nbsp;&nbsp; <img src="mail.png" style="height:15px;"> Email Us: HMS@gmail.com  
        ...
        <b class="login" style="font-size:20pt;">Sign UP</b><br/><br/>
...
mysqli_select_db($dbconnect, "dbhospital");
 ...
 $con = mysqli_connect("mysql.hostinger.ph", "u668189280_heart", "markhel418") or die("Error connecting to database: ".mysql_error());
     
 mysqli_select_db($con, "u668189280_heart") or die(mysqli_error());
...
if ($con->query($sql) === TRUE) {
    echo "<script type ='text/javascript'> alert ('You are now Registered to the Hospital.'); window.location.href='login.php';</script>";
} else {
