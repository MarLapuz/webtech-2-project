...
<html>
    ...
    <body style="background-image: url(loginbackground.png);"><header style="background-color:#68DCFA; color:white; padding: 5px 0px 0px 0px;"><img src="call.png" style="height:15px;">Call Us: (+639) 123 456 7890 &nbsp;&nbsp;&nbsp; <img src="mail.png" style="height:15px;"> Email Us: HMS@gmail.com  
        ...
        <b class="login" style="font-size:20pt;">ADD NEW USER</b><br/><br/>
        ...
        <br><br>
		Password:&nbsp;&nbsp;&nbsp;<input type="password" class="input" name="Password" placeholder="Password" required/>
		<br><br/>
        Account Description:
                <select name="AccountDescription" >
                <option>-----</option>  
        ...
        <input type="submit" style="width:100px;" class="button" value="Add User">
        </form><br/>
                <a href="admin.php"><input type="submit" class="button" value="Back"/></a>
            </fieldset>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($Username != "" AND $Password != "" AND $AccountDescription != ""){
        mysqli_query($dbconnect, "INSERT INTO tblaccounts SET Username='$Username', Password='$Password',     AccountDescription='$AccountDescription'");
        echo"<script>alert('New User Account Added!'); window.location.href='admin.php';</script>";
}
}
}
}
